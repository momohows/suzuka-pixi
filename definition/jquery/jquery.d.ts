...
/**
 * Interface of the JQuery extension of the W3C events object
 */
 ...
 * returning specific events objects.
 */
...
interface JQueryStatic {
    ...
    /**
     * Holds or releases the execution of jQuery's ready events.
     *
...
interface JQuery {
   ...
   outerHeight(height: number): JQuery;
    ...
    /**
     * Attach a handler to an events for the elements.
     * 
     * @param eventType A string containing one or more DOM events types, such as "click" or "submit," or custom events names.
     * @param eventData An object containing data that will be passed to the events handler.
     * @param handler A function to execute each time the events is triggered.
     */
     ...
     * @param eventType A string containing one or more DOM events types, such as "click" or "submit," or custom events names.
     * @param eventData An object containing data that will be passed to the events handler.
     * @param preventBubble Setting the third argument to false will attach a function that prevents the default action from occurring and stops the events from bubbling. The default is true.
     */
     ...
     * Attach a handler to an events for the elements.
     * 
     * @param events An object containing one or more DOM events types and functions to execute for them.
     */
    bind(events: any): JQuery;

    /**
     * Trigger the "blur" events on an element
     */
    blur(): JQuery;
    /**
     * Bind an events handler to the "blur" JavaScript events
     *
     * @param handler A function to execute each time the events is triggered.
     */
    ...
    /**
     * Trigger the "change" events on an element.
     */
    change(): JQuery;
    /**
     * Bind an events handler to the "change" JavaScript events
     *
     * @param handler A function to execute each time the events is triggered.
     */
    ...
    /**
     * Trigger the "click" events on an element.
     */
    click(): JQuery;
    /**
     * Bind an events handler to the "click" JavaScript events
     *
     * @param eventData An object containing data that will be passed to the events handler.
     */
    ...
    /**
     * Trigger the "dblclick" events on an element.
     */
    dblclick(): JQuery;
    /**
     * Bind an events handler to the "dblclick" JavaScript events
     *
     * @param handler A function to execute each time the events is triggered.
     */
    ...
    /**
     * Trigger the "focus" events on an element.
     */
    focus(): JQuery;
    /**
     * Bind an events handler to the "focus" JavaScript events
     *
     * @param handler A function to execute each time the events is triggered.
     */
    ...
    /**
     * Bind an events handler to the "focusin" JavaScript events
     *
     * @param handler A function to execute each time the events is triggered.
     */
    ...
    /**
     * Bind an events handler to the "focusout" JavaScript events
     *
     * @param handler A function to execute each time the events is triggered.
     */
    ...
    /**
     * Trigger the "keydown" events on an element.
     */
    keydown(): JQuery;
    /**
     * Bind an events handler to the "keydown" JavaScript events
     *
     * @param handler A function to execute each time the events is triggered.
     */
    ...
    /**
     * Trigger the "keypress" events on an element.
     */
    keypress(): JQuery;
    /**
     * Bind an events handler to the "keypress" JavaScript events
     *
     * @param handler A function to execute each time the events is triggered.
     */
    ...
    /**
     * Trigger the "keyup" events on an element.
     */
    keyup(): JQuery;
    /**
     * Bind an events handler to the "keyup" JavaScript events
     *
     * @param handler A function to execute each time the events is triggered.
     */
    ...
    /**
     * Bind an events handler to the "load" JavaScript events.
     *
     * @param handler A function to execute when the events is triggered.
     */
    ...
    /**
     * Trigger the "mousedown" events on an element.
     */
    mousedown(): JQuery;
    /**
     * Bind an events handler to the "mousedown" JavaScript events.
     *
     * @param handler A function to execute when the events is triggered.
     */
    ...
    /**
     * Trigger the "mouseenter" events on an element.
     */
    mouseenter(): JQuery;
    /**
     * Bind an events handler to be fired when the mouse enters an element.
     *
     * @param handler A function to execute when the events is triggered.
     */
    ...
    /**
     * Trigger the "mouseleave" events on an element.
     */
    mouseleave(): JQuery;
    /**
     * Bind an events handler to be fired when the mouse leaves an element.
     *
     * @param handler A function to execute when the events is triggered.
     */
    ...
    /**
     * Trigger the "mousemove" events on an element.
     */
    mousemove(): JQuery;
    /**
     * Bind an events handler to the "mousemove" JavaScript events.
     *
     * @param handler A function to execute when the events is triggered.
     */
    ...
    /**
     * Trigger the "mouseout" events on an element.
     */
    mouseout(): JQuery;
    /**
     * Bind an events handler to the "mouseout" JavaScript events.
     *
     * @param handler A function to execute when the events is triggered.
     */
    ...
    /**
     * Trigger the "mouseover" events on an element.
     */
    mouseover(): JQuery;
    /**
     * Bind an events handler to the "mouseover" JavaScript events.
     *
     * @param handler A function to execute when the events is triggered.
     */
    ...
    /**
     * Trigger the "mouseup" events on an element.
     */
    mouseup(): JQuery;
    /**
     * Bind an events handler to the "mouseup" JavaScript events.
     *
     * @param handler A function to execute when the events is triggered.
     */
    ...
    /**
     * Remove an events handler.
     */
    off(): JQuery;
    /**
     * Remove an events handler.
     *
     * @param events One or more space-separated events types and optional namespaces, or just namespaces, such as "click", "keydown.myPlugin", or ".myPlugin".
     * @param selector A selector which should match the one originally passed to .on() when attaching events handlers.
     * @param handler A handler function previously attached for the events(s), or the special value false.
     */
     ...
     * Remove an events handler.
     *
     * @param events An object where the string keys represent one or more space-separated events types and optional namespaces, and the values represent handler functions previously attached for the events(s).
     * @param selector A selector which should match the one originally passed to .on() when attaching events handlers.
     */
    off(events: { [key: string]: any; }, selector?: string): JQuery;

    /**
     * Attach an events handler function for one or more events to the selected elements.
     *
     * @param events One or more space-separated events types and optional namespaces, such as "click" or "keydown.myPlugin".
     * @param handler A function to execute when the events is triggered. The value false is also allowed as a shorthand for a function that simply does return false. Rest parameter args is for optional parameters passed to jQuery.trigger(). Note that the actual parameters on the events handler function must be marked as optional (? syntax).
     */
     ...
     *
     * @param events One or more space-separated events types and optional namespaces, such as "click" or "keydown.myPlugin".
     * @param data Data to be passed to the handler in events.data when an events is triggered.
     * @param handler A function to execute when the events is triggered. The value false is also allowed as a shorthand for a function that simply does return false.
    */
     ...
     *
     * @param events One or more space-separated events types and optional namespaces, such as "click" or "keydown.myPlugin".
     * @param selector A selector string to filter the descendants of the selected elements that trigger the events. If the selector is null or omitted, the events is always triggered when it reaches the selected element.
     * @param handler A function to execute when the events is triggered. The value false is also allowed as a shorthand for a function that simply does return false.
     */
     ...
     * Attach an events handler function for one or more events to the selected elements.
     *
     * @param events An object in which the string keys represent one or more space-separated events types and optional namespaces, and the values represent a handler function to be called for the events(s).
     * @param selector A selector string to filter the descendants of the selected elements that will call the handler. If the selector is null or omitted, the handler is always called when it reaches the selected element.
     * @param data Data to be passed to the handler in events.data when an events occurs.
     */
    ...
    /**
     * Attach a handler to an events for the elements. The handler is executed at most once per element per events type.
     *
     * @param events A string containing one or more JavaScript events types, such as "click" or "submit," or custom events names.
     * @param handler A function to execute at the time the events is triggered.
     */
     ...
     *
     * @param events A string containing one or more JavaScript events types, such as "click" or "submit," or custom events names.
     * @param data An object containing data that will be passed to the events handler.
     * @param handler A function to execute at the time the events is triggered.
     */
    ...
    /**
     * Trigger the "resize" events on an element.
     */
    resize(): JQuery;
    /**
     * Bind an events handler to the "resize" JavaScript events.
     *
     * @param handler A function to execute each time the events is triggered.
     */
    ...
    /**
     * Trigger the "scroll" events on an element.
     */
    scroll(): JQuery;
    /**
     * Bind an events handler to the "scroll" JavaScript events.
     *
     * @param handler A function to execute each time the events is triggered.
     */
    ...
    /**
     * Trigger the "select" events on an element.
     */
    select(): JQuery;
    /**
     * Bind an events handler to the "select" JavaScript events.
     *
     * @param handler A function to execute each time the events is triggered.
     */
    ...
    /**
     * Trigger the "submit" events on an element.
     */
    submit(): JQuery;
    /**
     * Bind an events handler to the "submit" JavaScript events
     *
     * @param handler A function to execute each time the events is triggered.
     */
    ...
    /**
     * Execute all handlers and behaviors attached to the matched elements for the given events type.
     * 
     * @param eventType A string containing a JavaScript events type, such as click or submit.
     * @param extraParameters Additional parameters to pass along to the events handler.
     */
    ...
    /**
     * Execute all handlers attached to an element for an events.
     * 
     * @param eventType A string containing a JavaScript events type, such as click or submit.
     * @param extraParameters An array of additional parameters to pass along to the events handler.
     */
    triggerHandler(eventType: string, ...extraParameters: any[]): Object;

    /**
     * Remove a previously-attached events handler from the elements.
     * 
     * @param eventType A string containing a JavaScript events type, such as click or submit.
     ...
     * Remove a previously-attached events handler from the elements.
     * 
     * @param evt A JavaScript events object as passed to an events handler.
     */
    unbind(evt: any): JQuery;

    /**
     * Remove a handler from the events for all elements which match the current selector, based upon a specific set of root elements.
     */
    undelegate(): JQuery;
    /**
     * Remove a handler from the events for all elements which match the current selector, based upon a specific set of root elements.
     * 
     * @param selector A selector which will be used to filter the events results.
     * @param eventType A string containing a JavaScript events type, such as "click" or "keydown"
     * @param handler A function to execute at the time the events is triggered.
     */
     ...
     * 
     * @param selector A selector which will be used to filter the events results.
     * @param events An object of one or more events types and previously bound functions to unbind from them.
     */
    ...
    /**
     * Bind an events handler to the "unload" JavaScript events. (DEPRECATED from v1.8)
     * 
     * @param handler A function to execute when the events is triggered.
     */
     ...
     * Bind an events handler to the "unload" JavaScript events. (DEPRECATED from v1.8)
     * 
     * @param eventData A plain object of data that will be passed to the events handler.
     * @param handler A function to execute when the events is triggered.
     */
    ...
    /**
     * Bind an events handler to the "error" JavaScript events. (DEPRECATED from v1.8)
     * 
     * @param handler A function to execute when the events is triggered.
     */
     ...
     * 
     * param withDataAndEvents A Boolean indicating whether events handlers and data should be copied along with the elements. The default value is false.
     * param deepWithDataAndEvents A Boolean indicating whether events handlers and data for all children of the cloned element should be copied. By default its value matches the first argument's value (which defaults to false).
     */
